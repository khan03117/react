...
function InfantDetails() {
    return (
        <>
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button p-3   border-bottom" type="button" data-bs-toggle="collapse" data-bs-target="#infantDetailsCollapse" aria-expanded="true" aria-controls="infantDetailsCollapse">
                        Infant (Max 0-2 yrs)
                    </button>
                </h2>
                <div id="infantDetailsCollapse" class="accordion-collapse collapse show" data-bs-parent="#infantDetails">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                <div className="w-100">
                                    ...
                                    <input type="date" name="dob" id="dob" className="form-control form-control-sm" />
                                </div>
                            </div>
                        </div>
